...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, StdCtrls, ExtCtrls, Grids, ComCtrls;
...
begin
  ...
  begin
    FMain.SG.ColCount := UGlobal.AIS.m + 1;
    FMain.SG.FixedCols := 1;
    FMain.SG.RowCount := UGlobal.AIS.n + 1;
    FMain.SG.FixedRows := 1;
    for i := 1 to AIS.n do
